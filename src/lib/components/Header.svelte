  ...
  <div class="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
    <div class="flex items-center gap-8">
      <a href="/" class="flex items-center gap-2">
        <svg width="32" height="41" viewBox="0 0 90 115" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <span class="text-xl font-bold tracking-tight font-sans">Commerce Systems</span>
      </a>
      
      <nav class="hidden md:flex items-center gap-6">
        {#each ["Product", "Solutions", "Security", "Company", "Careers"] as item}
    ...
    <div class="flex items-center gap-4">
      ...
      <a href="#demo" class="rounded-full bg-gray-900 px-4 py-2 text-sm font-medium text-white hover:bg-gray-800 transition-colors">
        Request Demo
      </a>
    </div>
  </div>
