        ...
        <div class="flex flex-col md:flex-row justify-between items-start mb-24 gap-12">
            <div class="max-w-xl">
                ...
                <h2 class="text-4xl md:text-5xl font-serif text-gray-900 leading-tight">
                    Transform Your<br />Operations with AI
                </h2>
            </div>
            <div>
                <a href="#demo" class="rounded-full bg-gray-900 px-6 py-3 text-sm font-medium text-white hover:bg-gray-800 transition-colors inline-block">
                    Request Demo
                </a>
            </div>
        </div>
